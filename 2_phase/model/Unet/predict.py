...
if __name__ == "__main__":
    ...
    test_path = "new_data/"
    test_x = sorted(glob(os.path.join(test_path, "img/test/", "*.jpg")))
    test_y = sorted(glob(os.path.join(test_path, "mask/test/", "*.jpg")))
    ...
    model = load_model_weight("files/model_final_2.hdf5")
